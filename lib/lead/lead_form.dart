...
class _LeadFormViewState extends State<LeadFormView>
  ...
  Future<bool> _convertOpportunity(
      int id, Map<String, dynamic> opportunityList) async {
    try {
                            ...
                            Radio<String>(
                              ...
                              onChanged: (String? value) {
                                setState(() {
                                  ...
                                  selectedLeads
                                      .clear(); // Clear selection when switching to Convert
                                });
                              },
                            ),
                    ...
                    if (conversionAction == "merge") ...[
                      ...
                      DropdownSearch<int>.multiSelection(
                        ...
                        itemAsString: (int? item) =>
                            availableLeadNames[availableLeadIds.indexOf(item!)],
                    ...
                    Column(
                      children: [
                        ...
                        if (customerOption == "exist") ...[
                          ...
                          SizedBox(height: 10),
                          DropdownSearch<int>(
                            enabled: customerOption ==
                                "exist", // Ensure the field is enabled only if 'exist' is selected
                            ...
                            items: customer_ids,
                            itemAsString: (int? item) =>
                                customer_items[customer_ids.indexOf(item!)],
                            onChanged: (value) {
                              setState(() {
